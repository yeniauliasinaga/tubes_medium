...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar text-start me-5"><img src="../Logo/simbol.png" style="width:100px; height:70px;"></a>
    <h2 class="text-right ">
    <div class="me-5 mx-5">
    <div class="collapse navbar-collapse mx-5" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mx-5 mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" ><img src="../Logo/notifikasi.webp" style="width:20px; height:20px;"></a>
        </li>
