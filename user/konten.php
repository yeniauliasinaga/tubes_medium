...
<body>
    ...
    <header>
        <div class="profile-1">
            <img height="48px" width='48px' src="https://miro.medium.com/fit/c/96/96/1*U6C7jnR_52gRkl6OTsGOrw.png"
                alt="Profile image">
        </div>
        <div class="info">
                    ...
                    <div class="card-1-btn-row card-row">
                        ...
                        <div class="card-row-icons">
                            <svg class='clap-icon' width="25" height="25">
                                <path
                                    d="M11.74 0l.76 2.97.76-2.97zM14.81 3.78l1.84-2.56-1.42-.47zM8.38 1.22l1.84 2.56L9.8.75zM20.38 
                                    ...
                                    2.96a7.16 7.16 0 0 0 1.18.1c1.03 0 2-.25 2.9-.7A5.9 5.9 0 0 0 21 22.24c3.34-3.34 3.08-6.93 1.74-9.17l-2.87-5.04z">
                                </path>
                            </svg>
                            <span>1.3k</span>
